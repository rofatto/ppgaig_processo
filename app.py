...
with aba3:
    ...
    itens = [
        ...
        ("2.1 Trabalhos completos em eventos (≥2p)", "0,6 ponto/unidade. Máx: 3,0 pontos.", 0.6, 3.0),
        ("2.2 Resumos publicados (<2p)", "0,3 ponto/unidade. Máx: 1,5 pontos.", 0.3, 1.5),
        ...
        ("5. Monitoria de disciplina", "0,6 ponto/semestre.", 0.6, 2.4),
